...
public class AlternateMazeState {
    ...
    public static void main(String[] args) {
        List<AlternateMazeState> states = getSampleStates(100);
        calculateExecutionSpeed(new StringAIPair("alphaBetaAction", state -> alphaBetaAction(state, END_TURN)), states);
        calculateExecutionSpeed(new StringAIPair("minMaxAction", state -> miniMaxAction(state, END_TURN)), states);
    }
    
    public static int H = 3;
    public static int W = 3;
    public static int END_TURN = 10;

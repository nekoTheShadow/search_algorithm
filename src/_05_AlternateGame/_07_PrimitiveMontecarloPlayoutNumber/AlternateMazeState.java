package _05_AlternateGame._07_PrimitiveMontecarloPlayoutNumber;
...
public class AlternateMazeState {
    ...
    public static void main(String[] args) {
        List<StringAIPair> ais = List.of(
            new StringAIPair("primitiveMontecarloAction 3000", state -> primitiveMontecarloAction(state, 3000)),
            new StringAIPair("primitiveMontecarloAction 30", state -> primitiveMontecarloAction(state, 30))
        );

...
import _05_AlternateGame._13_ThunderSearchWithTime.mctsAction.MctAction;
import _05_AlternateGame._13_ThunderSearchWithTime.thunderSearchAction.ThunderSearchAction;
...
public class Main {
    ...
    public static void main(String[] args) {
        List<StringAIPair> ais = List.of(
            ...
            new StringAIPair("mctsActionWithTimeThreshold 1ms", state -> MctAction.mctsActionWithTimeThreshold(state,1))
        );

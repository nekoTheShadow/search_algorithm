...
public class AlternateMazeState {
    ...
    public static void main(String[] args) {
        List<StringAIPair> ais = List.of(
            new StringAIPair("iterativeDeepeningAction 100", state -> iterativeDeepeningAction(state, 100)),
            new StringAIPair("iterativeDeepeningAction 1", state -> iterativeDeepeningAction(state, 1))
        );

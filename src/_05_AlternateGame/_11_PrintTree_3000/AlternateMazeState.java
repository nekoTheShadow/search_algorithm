...
public class AlternateMazeState {
    ...
    public static int mctsAction(AlternateMazeState state, int playoutNumber, boolean is_print) {
        ...
        {
            boolean calledCnt = false;
            if (is_print && !calledCnt) {
                System.out.println("mctsAction");
                rootNode.printTree();
            }
            calledCnt = true;
        }
    ...
    public static void main(String[] args) {
        AlternateMazeState state = new AlternateMazeState(0);
        mctsAction(state, 3000, true);
    }

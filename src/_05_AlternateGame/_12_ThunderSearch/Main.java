...
import _05_AlternateGame._12_ThunderSearch.mctsAction.MctAction;
import _05_AlternateGame._12_ThunderSearch.thunderSearchAction.ThunderSearchAction;

public class Main {

    public static void main(String[] args) {
        List<StringAIPair> ais = List.of(
            new StringAIPair("thunderSearchAction 300", state -> ThunderSearchAction.thunderSearchAction(state, 300)),
            new StringAIPair("mctsAction 300", state -> MctAction.mctsAction(state,300))
        );
